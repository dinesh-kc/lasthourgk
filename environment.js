    ...
    $scope.questions = [
      {
        ...
        "statements": {},
        "options": {
          "A": "सन् २०२२ नोभेम्बर १५ लाई Day of 8 Billion भनिन्छ।",
          ...
          "D": "नेपालको अन्तर्राष्ट्रिय मापदण्डको पहिलो वैज्ञानिक जनगणना वि.सं. २०१८ मा भएको थियो।"
        },
        "answer": "C"
      },
    
      {
        ...
        "statements": {
          ...
          "2": "इसिमोडका सार्कका सबै सदस्य राष्ट्र सदस्य छन्।",
      ...
      },
      {
        ...
        "options": {
          ...
          "B": "सर रोनाल्ड रोम",
          "C": "लुई पाश्चर",
          "D": "थियोडर स्वान(Theodor Schwann)"
        },
        "answer": "D"
      },
      {
        ...
        "options": {
          ...
          "B": "नेपालमा Capacity-3 अन्तर्गत ३ जिल्लामा लागु भएको थियो",
      ...
      {
        "question_number": 18,
        "question": "जे.एफ. डोब्रमेजका अनुसार नेपालमा कति प्रकारका पारिस्थितिक प्रणाली पाइन्छ?",
        "statements": {},
        "options": {
          "A": "११५",
          "B": "११०",
      ...
      },
      {
        ...
        "statements": {
          "i": "ओजन तह शब्द प्रयोग गर्ने पहिलो व्यक्ति J C Formen हुन्।",
          "ii": "हरित गृह प्रभावको अवधारणा ल्याउने व्यक्ति जिन फेरियर हुन्।",
      ...
      },
      {
        ...
        "options": {
          ...
          "D": "प्राकृतिक स्रोतलाई हेही नबिगारी जे जस्तो अवस्थामा छ सोही अवस्थामा कायम राख्ने धारणालाई निरपेक्ष संरक्षण भनिन्छ।"
        },
        "answer": "B"
      },

      {
        ...
        "statements": {
          "I": "WWF को लोगोमा अंकित चिन्हको निर्माण सर पिटर स्कट्ले गरेका हुन्।",
      ...
      {
        "question_number": 24,
        "question": "जलवायु परिवर्तनको प्रभाव कम गर्नका लागि विश्वको प्यानाकर्षण गर्ने पानीपुरी मन्त्रीपरिषदको बैठक गर्ने राष्ट्र कुन हो?",
        "statements": {},
        "options": {
          "A": "श्रीलंका",
          "B": "मालदिभ्स",
     ...
     
      {
        ...
        "statements": {
          "Centers": {
            ...
            "C": "गिद्व  प्रजनन केन्द्र - पिटौली, नवलपरासी",
      ...
      },
      {
        ...
        "feedback": "Green Peace को स्थापना सन् १९७१ मा भएको हो।",
        "options": {
      ...
      {
        "question_number": 53,
        "question": "WWF ले सन् २०२१ को २X२ पुरस्कार कुन राष्ट्रिय निकुञ्जलाई प्रदान गरेको हो?",
        "statements": {},
        "options": {
          "A": "बाँके",
          "B": "बर्दिया",
      ...
      },
      {
        ...
        "question": "तलका भनाईहरु विचार गर्नुहोस्।",
        "statements": {
          "i": "नेपाल नेट कार्यक्रम सञ्चालन गर्ने संस्था युनेस्को हो।",
      ...
      {
        "question_number": 56,
        "question": "तल दिइएको सम्बन्धले के जनाउँछ? हरिया घाँस → हरिण → बाघ ",
        "statements": {},
        "options": {
          "A": "खाद्य चक्र",
          "B": "खाद्य शृङ्खला",
      ...
      },
      {
        ...
        "statements": {
          "Pairs": {
            ...
            "B": "ओजन तह पातलिदै गएको पत्ता लगाउने → शेरउड रोल्याण्ड",
            "C": "RIO + 10 सम्मेलन     → जोहान्सबर्ग",
            "D": "अम्लिय वर्षा सम्बन्धि  सम्बन्धि पहिलो विश्व सम्मेलन → सन् १९९२"
          }
        },
        "options": {
